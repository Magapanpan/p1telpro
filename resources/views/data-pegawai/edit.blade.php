...
<div class="container mt-5">
    ...
    <input type="text" class="form-control" name="nomor_ktp" id="nomor_ktp" oninput="toggleKtpAttachmentField()">
    ...
    <select id="des_kel" class="form-control" name="des_kel">
        <option value="">Pilih Desa/Kelurahan</option>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="date" class="form-control" name="tanggal_mulai_kerja" value="{{ old('tanggal_mulai_kerja', $dataPegawai->other_email) }}" >
                        </div>

                        <div class="mb-4">
                            <label for="status_karyawan" class="form-label">Status Karyawan</label>
                            <input type="text" class="form-control" name="status_karyawan" value="{{ old('status_karyawan', $dataPegawai->other_email) }}" >
                        </div>
...
<div class="mb-4" id="lamp-sk-kartap-field" style="display: none;">
    ...
    <input type="file" class="form-control" name="lamp_sk_kartap">
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <input type="text" class="form-control" name="no_sk_promut" value="{{ old('no_sk_promut', $dataPegawai->no_sk_promut) }}" >
                                    </div>
...
<div id="children-fields" style="display: none;">
    <div class="mb-4">
        ...
        <input type="text" class="form-control" id="nama_anak_1" name="nama_anak_1" oninput="toggleChildFields()">
    </div>
    <div id="child-1-fields" style="display: none;">
        <div class="mb-4">
            <label for="tanggal_lahir_anak_1" class="form-label">Tanggal Lahir Anak 1</label>
            <input type="date" class="form-control" name="tanggal_lahir_anak_1">
        </div>
    </div>
    ...
    <div class="mb-4">
        ...
        <input type="text" class="form-control" id="nama_anak_2" name="nama_anak_2" oninput="toggleChildFields()">
    </div>
    <div id="child-2-fields" style="display: none;">
        <div class="mb-4">
            <label for="tanggal_lahir_anak_2" class="form-label">Tanggal Lahir Anak 2</label>
            <input type="date" class="form-control" name="tanggal_lahir_anak_2">
        </div>
    </div>
    ...
    <div class="mb-4">
        ...
        <input type="text" class="form-control" id="nama_anak_3" name="nama_anak_3" oninput="toggleChildFields()">
    </div>
    <div id="child-3-fields" style="display: none;">
        <div class="mb-4">
            <label for="tanggal_lahir_anak_3" class="form-label">Tanggal Lahir Anak 3</label>
            <input type="date" class="form-control" name="tanggal_lahir_anak_3">
        </div>
    </div>
</div>
...
<div id="lamp-ktp-pasangan-field" style="display: none;">
    ...
    <input type="text" class="form-control" name="no_kk" id="no_kk" oninput="toggleLampiranKK()" value="{{ old('no_kk', $dataPegawai->no_kk) }}">
    <small id="kk_note" style="color: red; display: none;">Nomor KK harus terdiri dari minimal 16 digit</small>
</div>

<div class="mb-4" id="lamp_kk_field" style="display: none;">
    ...
    <input type="text" class="form-control" name="no_bpjs_kes" id="no_bpjs_kes" oninput="toggleBpjsFields()">
...
<div class="mb-4">
    <label for="no_bpjs_tk" class="form-label">Nomor BPJS Tenaga Kerja</label>
    <input type="text" class="form-control" name="no_bpjs_tk" id="no_bpjs_tk" oninput="toggleBpjsFields()">
    <span id="bpjs-tk-error-message" style="color: red; font-size: 0.9em; display: none;">Nomor BPJS Tenaga Kerja minimal 11 karakter.</span>
</div>
...
<div class="mb-4" id="lamp_bpjs_tk_field" style="display: none;">
    ...
    <input type="text" class="form-control" name="npwp" id="npwp" value="{{ old('npwp', $dataPegawai->npwp) }}" oninput="checkNpwpField()">
    <small id="npwp-note" class="text-muted" style="display: none;">Masukkan 16 digit.</small>
</div>
...
<div class="mb-4" id="lamp-kartu-npwp-field" style="display: none;">
    ...
    <input type="file" class="form-control" name="lamp_kartu_npwp" placeholder="12.345.678.9-999.000">
</div>
...
function toggleBpjsFields() {
    ...
    const noBpjsTk = document.getElementById('no_bpjs_tk').value;
    ...
    const bpjsTkErrorMessage = document.getElementById('bpjs-tk-error-message');
...
function toggleLampiranKK() {
        var noKK = document.getElementById('no_kk').value;
        var kkNote = document.getElementById('kk_note');
        var lampKKField = document.getElementById('lamp_kk_field');

        // Cek jika panjang nomor KK adalah minimal 16 digit
        if (noKK.length >= 16) {
            // Menampilkan field lampiran KK
            lampKKField.style.display = 'block';
            kkNote.style.display = 'none'; // Menyembunyikan note
        } else {
            // Menyembunyikan field lampiran KK jika nomor KK kurang dari 16 digit
            lampKKField.style.display = 'none';
            // Menampilkan note jika nomor KK kurang dari 16 digit
            if (noKK.length > 0) {
    ...
    const npwpValue = npwpField.value.trim();

    if (/^\d{16}$/.test(npwpValue)) {
        // Jika NPWP valid (16 digit)
        ...
        npwpNote.style.display = 'block'; // Tampilkan note
        npwpNote.textContent = "Masukkan 16 digit."; // Ubah isi catatan
    }
}
