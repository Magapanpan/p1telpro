...
public function getKelurahan($id_kec)
    ...
    public function update(Request $request, $nik)
    {
        ...
        $request->validate([
            ...
            'lamp_foto_karyawan' => 'nullable|file|mimes:jpeg,png,jpg|max:2048',
            'lamp_ktp' => 'nullable|file|mimes:jpeg,png,jpg|max:2048',
            'lamp_sk_kartap' => 'nullable|file|mimes:pdf|max:2048',
            'lamp_sk_promut' => 'nullable|file|mimes:pdf|max:2048',
            'lamp_kontrak' => 'nullable|file|mimes:pdf|max:2048',
            'lamp_buku_nikah' => 'nullable|file|mimes:pdf|max:2048',
            'lamp_kk' => 'nullable|file|mimes:pdf|max:2048',
            'lamp_ktp_pasangan' => 'nullable|file|mimes:jpeg,png,jpg|max:2048',
            'lamp_akta_1' => 'nullable|file|mimes:pdf|max:2048',
            'lamp_akta_2' => 'nullable|file|mimes:pdf|max:2048',
            'lamp_akta_3' => 'nullable|file|mimes:pdf|max:2048',
            'lamp_bpjs_kes' => 'nullable|file|mimes:pdf|max:2048',
            'lamp_bpjs_tk' => 'nullable|file|mimes:pdf|max:2048',
            'lamp_kartu_npwp' => 'nullable|file|mimes:pdf|max:2048',
            'lamp_buku_rekening' => 'nullable|file|mimes:pdf|max:2048',
            'avatar_karyawan' => 'nullable|file|mimes:jpeg,png,jpg|max:2048',
        ]);
        ...
        $dataPegawai->update([
            ...
            'Alamat' => "{$dataPegawai->alamat}, RT/RW: {$dataPegawai->rt_rw}, {$dataPegawai->des_kel}, {$dataPegawai->kec}, {$dataPegawai->kab_kot}, {$dataPegawai->prov}, Kode Pos: {$dataPegawai->kode_pos}",
            'rt_rw' => $request->rt_rw,
